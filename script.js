...
girlRun.src = "assets/salma_run.jpeg";

const girlSprint = new Image();
girlSprint.src = "assets/salma_sprint.jpeg";

const girlJump = new Image();
girlJump.src = "assets/salma_jump.jpeg";
...
canvas.addEventListener("click", () => {
    if (player.onGround) {
        ...
        loveFrames.push({x: player.x + 20, y: player.y - 10, life: 30});
    }
});
...
document.getElementById("restartText").addEventListener("click", () => {
    location.reload();
});
